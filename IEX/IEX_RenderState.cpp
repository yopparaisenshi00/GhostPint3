...
void iexRenderState::Set( DWORD state, D3DMATERIAL9* lpMaterial, Texture2D* lpTexture )
{
	...
	case RS_ALPH:/*Transparent*/
				 
			iexSystem::Device->SetTextureStageState(0, D3DTSS_COLORARG1, D3DTA_TEXTURE);
			iexSystem::Device->SetTextureStageState(0, D3DTSS_COLORARG2, D3DTA_DIFFUSE);
