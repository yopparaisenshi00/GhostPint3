...
PADSET	iexInput::xbox360 = { AXIS_X, AXIS_Y, AXIS_RX, AXIS_RY, 1,1,1,1,   5,11, 9,   6,12,10,   7, 8 };	// XBOX360 Controller
...
void KEY_Vibration( DWORD gain, float period ){ input->Vibration( gain, period ); }
