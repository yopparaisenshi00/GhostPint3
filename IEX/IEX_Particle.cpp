...
//		構造体指定
//------------------------------------------------------
bool iexParticle::Set( LPPARTICLE pd )
{
...
//		データ個別指定
//------------------------------------------------------
bool iexParticle::Set( int type, int aFrame, DWORD aColor, int eFrame, DWORD eColor, int mFrame, DWORD mColor,
...
//		データ個別指定
//------------------------------------------------------
bool	iexParticle::Set( int type, int aFrame, float aAlpha, int eFrame, float eAlpha, int mFrame, float mAlpha,
						...
						float r, float g, float b, float scale, BYTE flag )
{
	...
	return Set( type, aFrame, aa|color, eFrame, ea|color, mFrame, ma|color, Pos, Move, Power, .0f, 1.0f, scale, flag );
}
