...
//エネミーLOCK解除時間(フレーム)群
#define ENEMY_LOCKTIME_A (300)//漂う奴
#define ENEMY_LOCKTIME_B (300)//普通の奴
#define ENEMY_LOCKTIME_C (200)//ワープする奴
#define ENEMY_LOCKTIME_D (350)//Z値移動する奴
#define ENEMY_LOCKTIME_E (150)//でかい奴
#define ENEMY_LOCKTIME_F (300)//トンボ
